...
bool Monitors::operator==(int diagonal)
{
	return this->diagonal==diagonal;
}

bool Monitors::operator<(const Monitors & monitor)
{
...
std::ostream & operator<<(std::ostream & out, const Monitors & monitor)
{
	return out << "Diagonal: " << monitor.diagonal << std::endl;
}
